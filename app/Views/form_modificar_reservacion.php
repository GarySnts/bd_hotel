...
<br><br>
    <form action="<?=base_url('modificar_reservacion')?>" method="post">
        <h1>Modificar reservación</h1><br>
        <div class="mb-3">
            <label for="txtId" class="form-label">Id de reservación</label>
            <input type="text" id="txtId" name="txtId" class="form-control" value="<?=$datos['reservacion_id'];?>" placeholder="Ingresar Id de la reservación" readonly>
        </div>
        <div class="mb-3">
            <label for="txtFecha" class="form-label">Fecha de reservación</label>
            <input type="text" id="txtFecha" name="txtFecha" class="form-control" value="<?=$datos['fecha'];?>" placeholder="INgresar fecha de la reservación">
        </div>
        <div class="mb-3">
            <label for="txtCliente" class="form-label">Id del cliente</label>
            <input type="text" id="txtCliente" name="txtCliente" class="form-control" value="<?=$datos['cliente_id'];?>" placeholder="Ingresar Id del cliente">
        </div>
        <div class="mb-3">
            <label for="txtHotel" class="form-label">Id del hotel</label>
            <input type="text" id="txtHotel" name="txtHotel" class="form-control" value="<?=$datos['hotel_id'];?>" placeholder="Ingresar Id del hotel">
        </div>
        <div class="mb-3">
            <label for="txtDescripcion" class="form-label">descripción de reservación</label>
            <input type="text" id="txtDescripcion" name="txtDescripcion" class="form-control" value="<?=$datos['descripcion'];?>" placeholder="Ingresar dscripción de la reservación">
        </div>
        <div class="mb-3">
            <label for="txtUser" class="form-label">Id del usuario</label>
            <input type="text" id="txtUser" name="txtUser" class="form-control" value="<?=$datos['usuario_id'];?>" placeholder="Ingresar Id del usuario">
        </div>
        <div class="mb-8">
